...
```
POST /api/v1/speech/recognize # 语音转文本 
POST /api/v1/speech/synthesize # 文本转语音 
...
POST /api/v1/ai/recommendations # 景点/餐厅推荐 
POST /api/v1/ai/optimize # 行程优化建议 
GET /api/v1/ai/weather/{location} # 天气信息获取
```
